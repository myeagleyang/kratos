...
import (
	...
	"gitlab.wwgame.com/wwgame/kratos/cmd/protoc-gen-go-errors/v2/errors"
)

const (
	errorsPackage = protogen.GoImportPath("gitlab.wwgame.com/wwgame/kratos/v2/errors")
