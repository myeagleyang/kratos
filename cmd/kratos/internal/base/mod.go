...
func KratosMod() string {
	...
	if path, err := ModuleVersion("gitlab.wwgame.com/wwgame/kratos/v2"); err == nil {
		// $GOPATH/pkg/mod/gitlab.wwgame.com/wwgame/kratos@v2
		return filepath.Join(cachePath, path)
	}
	// $GOPATH/src/gitlab.wwgame.com/wwgame/kratos
	return filepath.Join(gopath, "src", "gitlab.wwgame.com", "wwgame", "kratos")
}
