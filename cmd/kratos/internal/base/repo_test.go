...
func TestRepo(t *testing.T) {
	urls := []string{
		...
		"git@github.com:go-kratos/kratos.git",
		///path/to/repo.git/
		"//gitlab.wwgame.com/wwgame/kratos.git",
		// file:///path/to/repo.git/
		"file://./gitlab.wwgame.com/wwgame/kratos.git",
	}
...
func TestRepoClone(t *testing.T) {
	...
	if err := r.CopyTo(context.Background(), "/tmp/test_repo", "gitlab.wwgame.com/wwgame/kratos-layout", nil); err != nil {
		t.Fatal(err)
	}
	t.Cleanup(func() {
