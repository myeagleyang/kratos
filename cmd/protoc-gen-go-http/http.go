...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("gitlab.wwgame.com/wwgame/kratos/v2/transport/http")
	bindingPackage       = protogen.GoImportPath("gitlab.wwgame.com/wwgame/kratos/v2/transport/http/binding")
)
...
func buildMethodDesc(g *protogen.GeneratedFile, m *protogen.Method, method, path string) *methodDesc {
	...
	desc := strings.TrimSpace(strings.TrimPrefix(strings.TrimSuffix(comment, "\n"), "//"))
	if comment != "" {
