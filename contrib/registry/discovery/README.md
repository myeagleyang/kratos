...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/gitlab.wwgame.com/wwgame/kratos/contrib/registry/discovery/v2)
...
```go
import (
	"gitlab.wwgame.com/wwgame/kratos/contrib/registry/discovery/v2"
)
