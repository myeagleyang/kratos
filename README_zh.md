...
##### go install 安装：
```
go install gitlab.wwgame.com/wwgame/kratos/cmd/kratos/v2@latest
kratos upgrade
```
##### 源码编译安装：
```
git clone https://gitlab.wwgame.com/wwgame/kratos
cd kratos
make install
```
...
### Kratos Boot
```
import "gitlab.wwgame.com/wwgame/kratos/v2"
import "gitlab.wwgame.com/wwgame/kratos/v2/transport/grpc"
import "gitlab.wwgame.com/wwgame/kratos/v2/transport/http"
...
* [Service Layout](https://gitlab.wwgame.com/wwgame/kratos-layout)
