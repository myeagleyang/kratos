...
func TestNewEndpoint(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"https", "gitlab.wwgame.com/wwgame/kratos/"},
			want: &url.URL{Scheme: "https", Host: "gitlab.wwgame.com/wwgame/kratos/"},
		},
		{
...
func TestParseEndpoint(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "kratos",
			args:    args{endpoints: []string{"https://gitlab.wwgame.com/wwgame/kratos"}, scheme: "https"},
			want:    "github.com",
			wantErr: false,
		},
		{
