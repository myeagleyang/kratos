...
func TestMetadata_Inject(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "https://gitlab.wwgame.com/wwgame/kratos",
			args: args{"https://gitlab.wwgame.com/wwgame/kratos", propagation.HeaderCarrier{"mode": []string{"test"}}},
			want: "https://gitlab.wwgame.com/wwgame/kratos",
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				carrier: propagation.HeaderCarrier{"X-Md-Service-Name": []string{"https://gitlab.wwgame.com/wwgame/kratos"}},
			},
			want: "https://gitlab.wwgame.com/wwgame/kratos",
		},
		{
